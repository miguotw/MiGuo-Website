...
layout: post
title: 猫又みつる
description: Live2D 模型「みつる」資源分享！提供免費版下載，支援 VTube Studio 運行，內含表情切換功能。
date: 2025-05-31 00:00:00 +0800
image: '/assets/images/posts/猫又みつる/cover.gif'
...
![image](/assets/images/posts/猫又みつる/001.png)
...
<div class="button-group">
  <a class="button" href="/assets/files/posts/【Live2D】猫又みつる/Mituru_44(CC BY-NC-ND).zip"><i class="fa-solid fa-circle-down"></i>透過本站下載</a>
  <a class="button" href="https://miguo.fanbox.cc/posts/9968307" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-arrow-up-right-from-square"></i>前往 PIXIV FANBOX 下載</a>
</div>

如需商業使用，請前往下方按鈕下載，並遵守另一份授權條款。

<div class="button-group">
  <a class="button" href="https://miguo.fanbox.cc/posts/9967710" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-arrow-up-right-from-square"></i>前往 PIXIV FANBOX 下載（支援者限定）</a>
</div>
